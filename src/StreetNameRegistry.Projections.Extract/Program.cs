namespace StreetNameRegistry.Projections.Extract
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Console.WriteLine("Starting StreetNameRegistry.Projections.Extract");
            ...
            try
            {
                var runner = container.GetService<StreetNameExtractRunner>();
        ...
        private static IServiceProvider ConfigureServices(IConfiguration configuration)
        {
            ...
            builder
                .RegisterType<StreetNameExtractRunner>()
                .SingleInstance();
